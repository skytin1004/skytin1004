...
**Microsoft AI MVP • אחראי OSS של [Azure/co-op-translator](https://github.com/Azure/co-op-translator)**

לוקליזציה צריכה להיות תשתית, לא פרויקט.

אני בונה תשתית אוטומציה מרובת שפות שמקורית ל-GitHub.

## 🚀 Localizeflow

לוקליזציה לתיעוד שמקורית ל-GitHub.

מאריך את הרעיונות שנחקרו ב-Co-op Translator לאפליקציית GitHub מנוהלת במלואה.
...
אחראי על: https://github.com/Azure/co-op-translator

כלי שורת פקודה בקוד פתוח לתרגום מרובה שפות של Markdown + תמונות.

משמש במחסני למידה של Microsoft כולל:  
- AI גנרטיבי למתחילים  
- ML למתחילים  
- AI למתחילים  

מאוטומט תהליכי PR מרובי שפות ישירות מ-GitHub.

---

## למה אני עובד על לוקליזציה

לוקליזציה נכשלת לא כי ה-AI חלש,  
אלא כי היא הופכת לעומס תפעולי.

אני בונה תשתית שמסירה את העומס הזה.
...
>
> מאגר זה כולל 50+ תרגומים בשפות שונות שמגדילים משמעותית את גודל ההורדה. כדי לשכפל בלי תרגומים, השתמשו ב-sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> זה נותן לכם את כל מה שצריך לסיים את הקורס עם הורדה הרבה יותר מהירה.
...
- [Microsoft Learn Live – תכנן והכן לפיתוח פתרונות AI על Azure](https://www.youtube.com/watch?v=Zl_IFvrKaaY)  
...
[![סטטיסטיקות](https://github-readme-stats.vercel.app/api?username=skytin1004&show_icons=true&theme=tokyonight&rank_icon=github)](https://github.com/anuraghazra/github-readme-stats)  
