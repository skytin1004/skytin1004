...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-12T15:05:23+00:00",
...
**Pembuat [Localizeflow](https://localizeflow.com)**

**Microsoft AI MVP • Pemelihara OSS dari [Azure/co-op-translator](https://github.com/Azure/co-op-translator)**

Saya suka membangun alat pengembang berbasis AI sumber terbuka yang berskala global yang mengubah konsep tahap awal menjadi solusi siap produksi dengan dampak nyata.
...
> Repositori ini mencakup lebih dari 50+ terjemahan bahasa yang secara signifikan meningkatkan ukuran unduhan. Untuk meng-kloning tanpa terjemahan, gunakan sparse checkout:  
> ```bash
...
**Alur kerja penerjemahan dokumentasi otomatis asli GitHub**  
Tanpa pengaturan. Di-host. Sinkronisasi otomatis untuk proyek multibahasa.  
→ https://localizeflow.com

- Secara otomatis mendeteksi perubahan di file sumber Anda  
...
CLI OSS resmi Azure yang mengotomatisasi **penerjemahan multibahasa** untuk konten Markdown + gambar (OCR)  
**Dampak:** Menjalankan penerjemahan untuk repositori edukasi Microsoft dengan total 200k★+, memastikan konten selalu diperbarui dalam 10+ bahasa.

- Berkembang dari PoC awal → CLI Python tingkat produksi  
- Terintegrasi dengan Azure OpenAI + Azure AI Vision untuk penerjemahan + otomatisasi OCR  
...
- [Microsoft Learn Live – Rencanakan dan Siapkan untuk Mengembangkan Solusi AI di Azure](https://www.youtube.com/watch?v=Zl_IFvrKaaY)  
