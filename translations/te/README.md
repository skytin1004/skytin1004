...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T01:45:44+00:00",
...
# హాయ్, నేను మిన్సియోక్ సాంగ్!

[![GitHub Sponsors](https://img.shields.io/badge/Sponsor-%E2%9D%A4-lightgrey?logo=githubsponsors&style=for-the-badge)](https://github.com/sponsors/skytin1004)
[![Buy Me a Coffee](https://img.shields.io/badge/Buy%20Me%20a%20Coffee-FFDD00?logo=buymeacoffee&logoColor=black&style=for-the-badge)](https://coff.ee/skytin1004)

**[Localizeflow](https://localizeflow.com) సృష్టికర్త**
...
#### [Localizeflow](https://localizeflow.com/) ద్వారా మద్దతు
...
### 🚀 Localizeflow (ప్రస్తుత ప్రాజెక్ట్)
**GitHub-స్థానిక ఆటోమేటెడ్ డాక్యుమెంటేషన్ అనువాద వర్క్‌ఫ్లో**  
జీరో సెటప్. హోస్టెడ్. బహుభాషా ప్రాజెక్టుల కోసం ఆటో-సింక్.  
→ https://localizeflow.com

- మీ మూల ఫైళ్లలో మార్పులను ఆటోమేటిక్‌గా గుర్తిస్తుంది
- మారిన వాటినే అనువదిస్తుంది
- ప్రతి భాష కోసం PRలను తెరుస్తుంది
- Co-op Translator (Azure OSS) పై నిర్మించబడింది
...
- ప్రారంభ PoC నుండి → ఉత్పత్తి-స్థాయి Python CLIగా విస్తరించబడింది
- అనువాదం + OCR ఆటోమేషన్ కోసం Azure OpenAI + Azure AI Visionను సమగ్రపరిచింది
...
- **Open at Microsoft** OSS ప్రదర్శనలో ఫీచర్ చేయబడింది
- **Microsoft AI MVP 2025** పొందింది
...
- **1వ స్థానం**, ఇన్హా యూనివర్సిటీ ఓపెన్ సోర్స్ ఫెస్టివల్ (Co-op Translator)
- **విజేత**, Microsoft Korea Azurethon (Prompt Engineering విభాగం)
- **3× అత్యధిక వీక్షణల బ్లాగర్**, Microsoft Educator Developer Blog
...
## గణాంకాలు & కార్యకలాపం
<details>
<summary>GitHub గణాంకాలు చూడండి</summary>
...
1. 🗣 [microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners) లో [#484](https://github.com/microsoft/mcp-for-beginners/pull/484#issuecomment-3644265626) పై వ్యాఖ్యానించారు
