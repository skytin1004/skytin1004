...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T01:39:23+00:00",
...
Oficiální Azure OSS CLI, které automatizuje **vícejazyčné překlady** pro Markdown + obsah obrázků (OCR)  
**Dopad:** Pohání překlady pro Microsoft vzdělávací repozitáře s více než 200k★, zajišťující vždy aktuální obsah ve více než 10 jazycích.

- Vyvinuto z raného PoC → produkční Python CLI
- Integrované Azure OpenAI + Azure AI Vision pro překlad + OCR automatizaci
...
- [Microsoft Learn Live – Plánujte a připravujte vývoj AI řešení na Azure](https://www.youtube.com/watch?v=Zl_IFvrKaaY)  
...
1. 🗣 Komentoval na [#484](https://github.com/microsoft/mcp-for-beginners/pull/484#issuecomment-3644265626) v [microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)
