...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T01:33:13+00:00",
...
# สวัสดีครับ ผมชื่อ Minseok Song!
...
- ตรวจจับการเปลี่ยนแปลงในไฟล์ต้นฉบับของคุณโดยอัตโนมัติ
- แปลเฉพาะสิ่งที่เปลี่ยนแปลง
- เปิด PR สำหรับแต่ละภาษา
- สร้างบนพื้นฐานของ Co-op Translator (Azure OSS)


### **Co-op Translator (Microsoft Azure OSS)**

CLI OSS อย่างเป็นทางการของ Azure ที่ทำงานอัตโนมัติสำหรับ **การแปลหลายภาษา** สำหรับ Markdown + เนื้อหาภาพ (OCR)  
**ผลกระทบ:** สนับสนุนการแปลสำหรับที่เก็บข้อมูลการศึกษาของ Microsoft ที่มีดาวรวมกว่า 200k★+ เพื่อให้เนื้อหาอัปเดตเสมอในกว่า 10 ภาษา
...
- **อันดับ 1**, งานเทศกาลโอเพนซอร์ส มหาวิทยาลัย Inha (Co-op Translator)
- **ผู้ชนะ**, Microsoft Korea Azurethon (หมวดวิศวกรรมคำสั่ง)
- **บล็อกเกอร์ที่มีผู้ชมมากที่สุด 3 ครั้ง**, บล็อกนักพัฒนาการศึกษา Microsoft
...
1. 🗣 แสดงความคิดเห็นใน [#484](https://github.com/microsoft/mcp-for-beginners/pull/484#issuecomment-3644265626) ใน [microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)
