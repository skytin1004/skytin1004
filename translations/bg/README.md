...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T07:42:35+00:00",
...
**Microsoft AI MVP • Поддръжник на OSS проекта [Azure/co-op-translator](https://github.com/Azure/co-op-translator)**

Обичам да създавам разработчически инструменти с изкуствен интелект с отворен код, които се мащабират глобално, превръщайки първоначални концепции в готови за продукция решения с реално въздействие.
...
**GitHub-native автоматизиран работен процес за превод на документация**  
Нулева настройка. Хостван. Автоматично синхронизиране за многоезични проекти.  
→ https://localizeflow.com

- Автоматично открива промените във вашите изходни файлове
- Превежда само това, което е променено
- Отваря PRs за всеки език
...
**Въздействие:** Захранва преводите за учебни хранилища на Microsoft с общо над 200k★, осигурявайки винаги актуално съдържание на 10+ езика.

- Разширен от ранно PoC → продукционно ниво Python CLI
- Интегрира Azure OpenAI + Azure AI Vision за превод и автоматизация на OCR
...
- Представен в **Open at Microsoft** OSS витрина
...
- [Microsoft Learn Live – Планиране и подготовка за разработване на AI решения в Azure](https://www.youtube.com/watch?v=Zl_IFvrKaaY)  

---

## Признания
- **Microsoft Most Valuable Professional (AI)** 2024–2025
- **1-во място**, Inha University Open Source Festival (Co-op Translator)
- **Победител**, Microsoft Korea Azurethon (категория Prompt Engineering)
- **3× Най-гледан блогър**, Microsoft Educator Developer Blog
...
<details>
<summary>Преглед на GitHub статистика</summary>
