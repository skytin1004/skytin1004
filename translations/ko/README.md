...
> **로컬에서 복제하는 것을 선호하시나요?**
>
> 이 저장소에는 50개 이상의 언어 번역이 포함되어 있어 다운로드 크기가 상당히 커집니다. 번역 없이 복제하려면 sparse checkout을 사용하세요:
>
> **Bash / macOS / Linux:**
> ```bash
...
대부분의 소규모 팀은 전 세계 사용자를 서비스하기를 원합니다.  
하지만 로컬라이즈하지 않습니다.

번역이 비싸서가 아닙니다.  
AI가 부족해서가 아닙니다.

로컬라이제이션은 시작하는 순간 운영 프로젝트가 되기 때문입니다.
...
제가 Localizeflow를 만드는 이유는 바로 이 장벽을 없애기 위해서입니다.
...
다국어 Markdown + 이미지 번역을 자동화하는 CLI 입니다.

사용된 곳:  
- Generative AI for Beginners  
- ML for Beginners  
- AI for Beginners  
- 그리고 다른 Microsoft OSS 저장소들
