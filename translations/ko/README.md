...
> **로컬에서 클론하는 것을 선호하시나요?**
>
> 이 저장소는 50개 이상의 언어 번역을 포함하고 있어 다운로드 용량이 크게 증가합니다. 번역 없이 클론하려면 스파스 체크아웃을 사용하세요:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> 더 빠른 다운로드로 강의를 완료하는 데 필요한 모든 내용을 제공합니다.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## 제가 로컬라이제이션 작업을 하는 이유

대부분의 소규모 팀은 전 세계 사용자를 대상으로 하고 싶어합니다.  
하지만 현지화 작업은 하지 않습니다.

번역이 비싸서도 아니고,  
AI가 약해서도 아닙니다.

운영 프로젝트가 시작되는 순간부터 로컬라이제이션은 부담이 되기 때문입니다.
...
그래서 작업을 미루거나 시작도 하지 않습니다.

저는 Localizeflow를 만들어 이 장벽을 제거하려 합니다.

---

## 🚀 Localizeflow

GitHub에 최적화된 문서 로컬라이제이션.  
한 번 설치. YAML 없음. API 키 없음. 대시보드 없음.
...
Azure/co-op-translator 유지관리자

다국어 Markdown 및 이미지 번역을 자동화하는 CLI 도구.

사용처:  
- Generative AI for Beginners  
- ML for Beginners  
- AI for Beginners  
- 기타 Microsoft OSS 저장소
...
- [Open at Microsoft – Co-op Translator로 다국어 접근성 향상](https://www.youtube.com/watch?v=jX_swfH_KNU)  
