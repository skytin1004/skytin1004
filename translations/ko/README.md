...
대부분의 소규모 팀은 글로벌 사용자를 지원하고 싶어 합니다.  
하지만 현지화하지 않습니다.

번역이 비싸서가 아닙니다.  
AI가 약해서도 아닙니다.

현지화는 시작하는 순간부터 운영 프로젝트가 되기 때문입니다.
...
GitHub 네이티브 문서 현지화.  
한 번 설치하면 끝. YAML도 API 키도 대시보드도 필요 없습니다.
...
다국어 Markdown + 이미지 번역을 자동화하는 CLI입니다.
...
- [Microsoft에서 공개 – Co-op Translator와 함께하는 다국어 접근성 강화](https://www.youtube.com/watch?v=jX_swfH_KNU)  
