...
> **로컬에서 클론하는 것이 더 편하신가요?**
>
> 이 저장소는 50개 이상의 언어 번역을 포함하고 있어 다운로드 크기가 매우 큽니다. 번역 없이 클론하려면 sparse checkout을 사용하세요:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> 이 방법으로 훨씬 빠르게 다운로드하면서 코스를 완료하는 데 필요한 모든 것을 얻을 수 있습니다.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## 내가 로컬라이제이션 작업을 하는 이유

대부분의 작은 팀들은 글로벌 사용자를 대상으로 서비스를 제공하고 싶어 합니다.  
하지만 로컬라이즈하지 않습니다.

번역이 비싸서가 아닙니다.  
AI가 부족해서도 아닙니다.

로컬라이제이션을 시작하는 순간부터 운영 프로젝트가 되기 때문입니다.
...
저는 그 장벽을 제거하기 위해 Localizeflow를 만들고 있습니다.

---

## 🚀 Localizeflow

GitHub 네이티브 문서 로컬라이제이션.  
한 번 설치하세요. YAML도 API 키도 대시보드도 필요 없습니다.
...
Azure/co-op-translator 유지 관리자

여러 언어의 Markdown + 이미지 번역을 자동화하는 CLI 도구입니다.
