...
> **로컬로 복제하시겠습니까?**
>
> 이 저장소에는 50개 이상의 언어 번역이 포함되어 있어 다운로드 용량이 크게 증가합니다. 번역 없이 복제하려면 sparse checkout을 사용하세요:
>
> **Bash / macOS / Linux:**
> ```bash
...
## 왜 저는 로컬라이제이션 작업을 하는가

대부분의 소규모 팀은 전 세계 사용자에게 서비스를 제공하고 싶어합니다.  
하지만 로컬라이즈하지 않습니다.

번역이 비싸서가 아닙니다.  
AI가 약해서도 아닙니다.

바로 로컬라이제이션이 시작되자마자 운영 프로젝트가 되기 때문입니다.
...
한 번 설치하면 YAML도, API 키도, 대시보드도 없습니다.
...
다국어 Markdown + 이미지 번역을 자동화하는 CLI.
