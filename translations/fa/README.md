...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T01:24:57+00:00",
...
من عاشق ساخت ابزارهای توسعه‌دهنده متن‌باز و مبتنی بر هوش مصنوعی هستم که در مقیاس جهانی قابل استفاده‌اند و مفاهیم اولیه را به راه‌حل‌های آماده تولید با تأثیر واقعی تبدیل می‌کنند.
...
**روند کاری ترجمه خودکار مستندات بومی‌شده در گیت‌هاب**  
...
یک CLI رسمی آزور OSS که ترجمه‌های چندزبانه را برای محتوای Markdown + تصویر (OCR) خودکار می‌کند  
...
- **برنده**، آزورثون مایکروسافت کره (دسته مهندسی پرامپت)
- **۳× بلاگر پربازدید**، بلاگ توسعه‌دهنده آموزشی مایکروسافت
...
1. 🗣 نظر داد در [#484](https://github.com/microsoft/mcp-for-beginners/pull/484#issuecomment-3644265626) در [microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)
