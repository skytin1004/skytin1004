...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T01:25:27+00:00",
...
#### [Localizeflow](https://localizeflow.com/) کی مدد سے
...
**اثر:** Microsoft کے تعلیمی ریپوزٹریز کے لیے 200k★+ کے کل ستاروں کے ساتھ تراجم کو طاقت دیتا ہے، جو 10+ زبانوں میں ہمیشہ تازہ ترین مواد کو یقینی بناتا ہے۔
...
- درج ذیل ریپوز میں استعمال ہوتا ہے:
...
<details>
<summary>GitHub کے اعداد و شمار دیکھیں</summary>
...
1. 🗣 نے [#484](https://github.com/microsoft/mcp-for-beginners/pull/484#issuecomment-3644265626) پر تبصرہ کیا [microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners) میں
