...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-23T22:47:52+00:00",
  "source_file": "README.md",
  "language_code": "uk"
}
-->
![Банер заголовка](https://github.com/user-attachments/assets/e5c72b81-0bcb-403a-9efe-76d04991d303)

# Привіт, я Minseok Song! 

[![Спонсори GitHub](https://img.shields.io/badge/Sponsor-%E2%9D%A4-lightgrey?logo=githubsponsors&style=for-the-badge)](https://github.com/sponsors/skytin1004)
[![Купи мені каву](https://img.shields.io/badge/Buy%20Me%20a%20Coffee-FFDD00?logo=buymeacoffee&logoColor=black&style=for-the-badge)](https://coff.ee/skytin1004)

**Автор [Localizeflow](https://localizeflow.com)**

**Microsoft AI MVP • Мейнтейнер OSS репозиторію [Azure/co-op-translator](https://github.com/Azure/co-op-translator)**

Мені подобається створювати інструменти для розробників з підтримкою AI з відкритим вихідним кодом, які масштабуються глобально, перетворюючи ранні концепти в готові до виробництва рішення з реальним впливом.
...
### 🚀 Localizeflow (поточний проєкт)
**Автоматизований робочий процес перекладу документації, рідний для GitHub**  
Без налаштувань. Хостинг. Автосинхронізація для мультимовних проєктів.  
...
Офіційний Azure OSS CLI, який автоматизує **багатомовні переклади** для контенту в Markdown та зображеннях (OCR)  
**Вплив:** Забезпечує переклади для навчальних репозиторіїв Microsoft загалом 200k★+, гарантуючи завжди оновлений контент більш ніж 10 мовами.

- Масштабовано від раннього PoC → до production-рівня Python CLI
- Інтегровано Azure OpenAI + Azure AI Vision для автоматизації перекладу + OCR
- Використовується у репозиторіях, таких як:
  - [Generative AI for Beginners](https://github.com/microsoft/Generative-AI-for-beginners) (84k★)
  - [ML for Beginners](https://github.com/microsoft/ML-for-Beginners) (72k★)
  - [AI for Beginners](https://github.com/microsoft/AI-for-Beginners) (37k★)
  - [AI Agents for Beginners](https://github.com/microsoft/AI-Agents-for-Beginners) (17k★)
  - [PhiCookbook](https://github.com/microsoft/PhiCookbook) (3k★)
- Представлено в OSS-шоукейсі **Open at Microsoft**
- Отримав **Microsoft AI MVP 2025**
...
- [Open at Microsoft – Забезпечення мультимовної доступності з Co-op Translator](https://www.youtube.com/watch?v=jX_swfH_KNU)  
- [Microsoft Learn Live – Плануйте та готуйтеся до розробки AI-рішень на Azure](https://www.youtube.com/watch?v=Zl_IFvrKaaY)  

---

## Визнання
- **Microsoft Most Valuable Professional (AI)** 2024–2025
- **1-ше місце**, Inha University Open Source Festival (Co-op Translator)
- **Переможець**, Microsoft Korea Azurethon (категорія Prompt Engineering)
- **3× Найбільш переглянутий блогер**, Microsoft Educator Developer Blog
...
<details>
<summary>Переглянути статистику GitHub</summary>
