...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-13T11:55:15+00:00",
...
**Microsoft AI MVP • OSS Maintainer проєкту [Azure/co-op-translator](https://github.com/Azure/co-op-translator)**

Я люблю створювати інструменти для розробників на базі штучного інтелекту з відкритим кодом, які масштабуються по всьому світу, перетворюючи початкові концепції у готові до виробництва рішення з реальним впливом.
...
**Автоматизований робочий процес перекладу документації, інтегрований з GitHub**  
Нульова настройка. Хостинг. Автосинхронізація для багатомовних проєктів.  
...
- Представлено в демонстрації OSS **Open at Microsoft**
...
- [Open at Microsoft – Розкриття багатомовної доступності з Co-op Translator](https://www.youtube.com/watch?v=jX_swfH_KNU)  
