...
**Mwanzilishi wa [Localizeflow](https://localizeflow.com)**

**Microsoft AI MVP • Msimamizi wa OSS wa [Azure/co-op-translator](https://github.com/Azure/co-op-translator)**

Uwekaji wa lugha unapaswa kuwa miundombinu, si mradi.

Ninaunda miundombinu ya otomatiki ya lugha nyingi ya asili ya GitHub.

## 🚀 Localizeflow

Uwekaji wa lugha wa nyaraka za asili za GitHub.

Kueneza mawazo yaliyochunguzwa katika Co-op Translator kuwa App ya GitHub inayosimamiwa kikamilifu.

Hakuna YAML.  
Hakuna funguo za API.  
Hakuna matengenezo ya mtiririko wa kazi.

- Inagundua mabadiliko ya chanzo  
- Inatafsiri tu kilichobadilika  
- Hufungua ombi la pull moja kwa moja  
- Inaendesha kwenye miundombinu inayosimamiwa  

Imejengwa kwa ajili ya:
- Wasimamizi wa OSS  
- Waendelezaji wadogo  
- Maanzilishi wa kampuni za hatua za mwanzo  

→ https://localizeflow.com

## 🛠 Co-op Translator (Azure OSS)

Msimamizi wa: https://github.com/Azure/co-op-translator

CLI ya chanzo huria kwa tafsiri ya Markdown + picha katika lugha nyingi.

Inatumiwa katika hazina za kujifunza za Microsoft zikiwemo:
- AI ya kizazi kwa Waanzilishi  
- ML kwa Waanzilishi  
- AI kwa Waanzilishi  

Inaotomatiki mtiririko wa kazi wa PR wa lugha nyingi moja kwa moja kutoka GitHub.

---

## Kwa Nini Ninafanya Kazi ya Uwekaji Lugha

Uwekaji lugha hudumu si kwa sababu AI ni dhaifu,
lakini kwa sababu huleta mzigo wa uendeshaji.

Ninaunda miundombinu inayotoa mzigo huo.
...
>
> Hifadhidata hii ni pamoja na tafsiri zaidi ya lugha 50 ambazo huongeza kwa kiasi kikubwa ukubwa wa pakua. Ili kuikopa bila tafsiri, tumia sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
- [Microsoft Learn Live – Panga na Jiandae Kuunda Suluhisho za AI kwenye Azure](https://www.youtube.com/watch?v=Zl_IFvrKaaY)  
