...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-12T14:50:11+00:00",
...
**[Localizeflow](https://localizeflow.com) 嘅創作者**

**Microsoft AI MVP • [Azure/co-op-translator](https://github.com/Azure/co-op-translator) 嘅開源維護者**

我鍾意構建 AI 驅動嘅、開源嘅開發工具，並具備全球擴展性，將早期階段嘅概念轉化為具有實際影響力嘅生產就緒方案。
...
### **Co-op Translator（Microsoft Azure 開源軟件）**

一個官方 Azure 開源 CLI，自動化支援 Markdown + 圖像內容（OCR）嘅**多語言翻譯**  
**影響力：** 支援 Microsoft 教育相關倉庫，累計 20 萬★+，確保持續更新逾 10 種語言嘅內容。

- 從早期概念驗證（PoC）發展成生產級 Python CLI
- 整合 Azure OpenAI + Azure AI Vision 進行翻譯和 OCR 自動化
- 被多個倉庫採用，例如：
...
- 在 **Open at Microsoft** 開源項目展示會中亮相
...
- [Open at Microsoft – 利用 Co-op Translator 解鎖多語言無障礙](https://www.youtube.com/watch?v=jX_swfH_KNU)  
- [Microsoft Learn Live – 計劃及準備於 Azure 開發 AI 解決方案](https://www.youtube.com/watch?v=Zl_IFvrKaaY)  
