...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-12T12:35:37+00:00",
...
**Креатор [Localizeflow](https://localizeflow.com)**

**Microsoft AI MVP • Одржавач отвореног кода [Azure/co-op-translator](https://github.com/Azure/co-op-translator)**

Волим да правим алате за програмере покретане вештачком интелигенцијом, отвореног кода, који се глобално проширују и претварају концепте из ране фазе у решења спремна за производњу са стварним утицајем.
...
> Ово складиште укључује преко 50 превода језика што значајно повећава величину преузимања. Да бисте клонирали без превода, користите sparse checkout:
> ```bash
...
Нема потребе за подешавањем. Домаћин. Аутоматска синхронизација за вишезначне пројекте.  
→ https://localizeflow.com

- Аутоматски детектује промене у вашим изворним фајловима
...
Званични Azure OSS CLI који аутоматизује **вишезначне преводе** за Markdown + садржај слика (OCR)  
**Утицај:** Омогућава преводе за Microsoft образовна складишта укупне величине преко 200k★+, обезбеђујући свеже ажуриран садржај на 10+ језика.

- Проширио се од раног PoC → производног Python CLI
- Интегрисан Azure OpenAI + Azure AI Vision за превод и OCR аутоматизацију
- Користе га складишта као:
  - [Generative AI for Beginners](https://github.com/microsoft/Generative-AI-for-beginners) (84k★)
  - [ML for Beginners](https://github.com/microsoft/ML-for-Beginners) (72k★)
  - [AI for Beginners](https://github.com/microsoft/AI-for-Beginners) (37k★)
  - [AI Agents for Beginners](https://github.com/microsoft/AI-Agents-for-Beginners) (17k★)
  - [PhiCookbook](https://github.com/microsoft/PhiCookbook) (3k★)
- Представљен у **Open at Microsoft** представљању отвореног кода
...
- [Open at Microsoft – Откључавање вишезначе приступачности уз Co-op Translator](https://www.youtube.com/watch?v=jX_swfH_KNU)  
...
- **1. место**, Инха Универзитетски фестивал отвореног кода (Co-op Translator)
- **Победник**, Microsoft Korea Azurethon (категорија Промпт Енгинееринг)
- **3× Најгледанији блогер**, Microsoft Educator Developer Blog
