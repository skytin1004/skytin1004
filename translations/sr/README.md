...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T06:27:31+00:00",
...
**Творац [Localizeflow](https://localizeflow.com)**

**Microsoft AI MVP • OSS Maintainer of [Azure/co-op-translator](https://github.com/Azure/co-op-translator)**

Волим да правим AI-подржане, отвореног кода алате за програмере који се скалирају глобално, претварајући концепте из ране фазе у продукцијска решења са стварним утицајем.
...
**GitHub-нативан аутоматизовани ток за превод документације**  
Нема потребе за подешавањем. Хостовано. Аутоматска синхронизација за вишезичне пројекте.  
→ https://localizeflow.com

- Аутоматски открива измене у вашим изворним фајловима
- Преводи само оно што је измењено
- Отвара PR-ове за сваки језик
- Изграђен на врху Co-op Translator (Azure OSS)


### **Co-op Translator (Microsoft Azure OSS)**

Службени Azure OSS CLI који аутоматизује **вишезичне преводе** за Markdown + садржај слика (OCR)  
**Утицај:** Омогућава превођење Microsoft едукативних репозиторијума укупно са 200k★+, обезбеђујући увек ажуриран садржај на преко 10 језика.

- Развијен од раног PoC до производног Python CLI
- Интегрисан Azure OpenAI + Azure AI Vision за превод и аутоматизацију OCR-а
...
- Истакнут у презентацији OSS-а **Open at Microsoft**
- Освојио је **Microsoft AI MVP 2025**
...
- [Open at Microsoft – Омогућавање вишезичке приступачности уз Co-op Translator](https://www.youtube.com/watch?v=jX_swfH_KNU)  
...
- **3× Најчитанији блогер**, Microsoft Educator Developer Blog
