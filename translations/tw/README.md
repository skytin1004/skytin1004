...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T05:50:46+00:00",
  "source_file": "README.md",
  "language_code": "tw"
}
-->
![頁首橫幅](https://github.com/user-attachments/assets/e5c72b81-0bcb-403a-9efe-76d04991d303)
...
[![請我喝杯咖啡](https://img.shields.io/badge/Buy%20Me%20a%20Coffee-FFDD00?logo=buymeacoffee&logoColor=black&style=for-the-badge)](https://coff.ee/skytin1004)

**Localizeflow 的創作者**

**Microsoft AI MVP • [Azure/co-op-translator](https://github.com/Azure/co-op-translator) 的 OSS 維護者**

我熱衷於打造具 AI 能力的開源開發者工具，能夠全球擴展，將早期概念轉化為具有實際影響力的生產就緒解決方案。

### 🌐 多語言支援

#### 由 [Localizeflow](https://localizeflow.com) 提供支援
...
- 僅翻譯已變更的內容
- 為每種語言開啟 PR
- 建置於 Co-op Translator（Azure OSS）之上


### **Co-op Translator (Microsoft Azure OSS)**

一個官方的 Azure OSS CLI，可自動化 **多語翻譯**，處理 Markdown + 圖像內容（OCR）  
**影響力：** 為微軟的教學型倉庫提供翻譯服務，累計超過 200k★，確保 10+ 種語言的內容持續更新。

- 從早期 PoC 擴展到具生產等級的 Python CLI
- 整合 Azure OpenAI + Azure AI Vision 以自動化翻譯與 OCR
- 被下列倉庫採用：
...
- 出現在 **Open at Microsoft** 的 OSS 展示
...
- [Open at Microsoft – 使用 Co-op Translator 解鎖多語可及性](https://www.youtube.com/watch?v=jX_swfH_KNU)  
- [Microsoft Learn Live – 計畫並準備在 Azure 上開發 AI 解決方案](https://www.youtube.com/watch?v=Zl_IFvrKaaY)  
...
- **3× 最受歡迎部落客**, Microsoft Educator Developer Blog
...
## 統計與活動
<details>
<summary>檢視 GitHub 統計資料</summary>
